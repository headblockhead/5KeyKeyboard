...
def convertLine(line):
    ...
    for key in filter(None, line.split(" ")):
        ...
        command_mediacode = duckyMediaCommands.get(key, None)
        if command_keycode is not None:
            # if it exists in the list, use it
            newline.append(command_keycode)
        elif command_mediacode is not None:
            # if it's in the media commands list, use it
            newline.append(command_mediacode)
